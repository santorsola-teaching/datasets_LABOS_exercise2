...
output:
 html_document:
   toc: true
params:
    quant_path: /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise2/results/salmon
    ...
    vcf:  /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise2/results/annotation/haplotypecaller/joint_variant_calling/joint_germline_recalibrated_snpEff.ann.vcf.gz
...
selectedVars$alphamis_Pathogenicity = c(0.24,0.085,0.075,0.073,0.113,0.333,0.361,0.507,0.565,0.718,0.083,0.055,0.074,0.054,0.084,0.177,0.635,0.069,0.549,0.124,0.17,0.116,0.457,0.068,0.469,0.848,0.419,0.096,0.304,0.23,0.172,0.287,0.092,0.107)

selectedVars$alphamis_Class = c("likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","ambiguous","ambiguous","likely_pathogenic","likely_pathogenic","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","likely_pathogenic","likely_benign","ambiguous","likely_benign","likely_benign","likely_benign","ambiguous","likely_benign","ambiguous","likely_pathogenic","ambiguous","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign","likely_benign")
...
genes <- c("APP", "ITSN1", "CBR3", "COL6A1")
loeuf <-c(0.41, 0.3, 1.85, 0.71)
...
```{r}
prioritised_variants$Clinical_significance <- c("Conflicting interpretations of pathogenicity", "Conflicting interpretations of pathogenicity", "Likely benign", "Likely benign")
prioritised_variants$gnomAD_AF <- c("1.30e-4", "2.55e-4", "2.13e-5", "9.11e-5")
